#This Code allows us to load a file, edit it and save the changes..
#Plotting the selected values will be uploaded shortly
...
class MyWindow(QtWidgets.QWidget):
    def __init__(self, fileName, parent=None):
        ...
        self.pushPlot=QtWidgets.QPushButton(self)
        self.pushPlot.setText("Plot")
        self.pushPlot.clicked.connect(self.handlePlot)
        self.pushPlot.setFixedWidth(60)
        self.pushPlot.setStyleSheet(stylesheet(self))
        ...
        grid.addWidget(self.pushPlot,0,8)
